...
@EnableSwagger2
public class MsGestaoMunicipalOrcamentoApplication {

	public static final String AUTHORIZATION_HEADER = "Authorization";
	public static final String DEFAULT_INCLUDE_PATTERN = "/resource/.*";
	 
	public static void main(String[] args) {
		SpringApplication.run(MsGestaoMunicipalOrcamentoApplication.class, args);
		
		DadosTest dt = new DadosTest();
		dt.criaOrcamentoTest();
	...
	private ApiInfo apiDetails() {
		...
		return new ApiInfo(
				"Gestão Municipal - Orçamento", 
				"API do microsserviço de gestão de orçamento",
				"1.0", 
				"Teams of Service", 
